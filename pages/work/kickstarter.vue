<template>
  <section class="full-height work-sample work-kickstarter top-level">
    <div class="">
      <div
      ...
      >
        ...
        >
          ...
          <ol class="toc mt-6 text-lg">
            ...
            <li class="py-2">
              <a href="#" v-scroll-to="'#product-process'"
                >Product process and culture</a
              >
            </li>
            <li class="py-2">
              <a href="#" v-scroll-to="'#select-projects'"
                >Select projects &amp; initiatives</a
              >
            </li>
          </ol>
        </div>
      ...
      <div
        ...
        data-aos-easing="ease-in-out"
      >
        <div id="creating-a-design-organization" class="relative mx-auto py-10">
          ...
          <img
            ...
            data-aos-duration="1000"
            data-aos-easing="ease-in-out"
            src="@/assets/work/kickstarter/ksr-charter.png"
          />
          <span class="caption">
            Kickstarter's mission is to help bring creative projects to life.
          </span>
          <h3 class="text-xl">Optimize the hiring process</h3>
          <p>
          ...
          <p>
            One of the benefits of my experience at Google is that I've
          ...
          <p>
            At its largest, I scaled my team to 8 product designers, 1 UX
          ...
          <h3 class="text-xl mt-4">Blaze a clear growth path</h3>
          <p>
          ...
          <h2 class="text-3xl font-bold mb-6" id="product-process">
            Product process and culture
          </h2>
          <p class="text-xl">
            I established several core practices that I believe are essential to
          ...
          <h3 class="text-xl mt-4">Reboot design systems and tooling</h3>
          <p>
          ...
          <img
            ...
            data-aos-duration="1000"
            data-aos-easing="ease-in-out"
            src="@/assets/work/kickstarter/kds.png"
          />
          <span class="caption">
          ...
          <p>
            Figma allows us to have shared libraries of patterns, components,
          ...
          <h3 class="text-xl mt-10">Make user research a core practice</h3>
          ...
          <h2 class="text-3xl font-bold mb-6" id="select-projects">
          ...
          >
            <div class="meta col-span-2">
              ...
              >
                <img src="@/assets/work/kickstarter/add-ons.png" />
              </div>
              <p class="problem">
            ...
            <div class="meta col-span-2">
              ...
              >
                <video
                  ...
                  muted
                  loop
                  src="@/assets/work/kickstarter/project-budget.mp4"
                />
              </div>
              <p class="problem">
          ...
          >
            <div class="meta col-span-2">
              ...
              <div
                class="art overflow-hidden rounded-md background-black col-span-4"
              >
                <img src="@/assets/work/kickstarter/ksr10.png" />
              </div>
              <p class="problem">
